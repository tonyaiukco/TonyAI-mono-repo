...
- **Phase:** Phase 1 — Core MVP (Scope 1 & 2) — WP1–WP3 done; only WP4 (E2E & hardening) remains
- **Latest merged:** PR #16 (WP2 anomaly detection); WP3 period locking on `feat/period-locking` (uncommitted)
...
**Next up:** WP4 — E2E & hardening (Phase 1 exit gate): Playwright coverage + live PostgREST RLS containment probes.
