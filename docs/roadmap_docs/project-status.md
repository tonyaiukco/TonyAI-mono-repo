...
- **Latest merged:** PR #21 (WP5) + #22 (auth-guard fix); WP6 Reports on `feat/reports` (uncommitted)
- **Tests:** 161 unit (Vitest, API) + 14 E2E (Playwright) + 18 live RLS containment probes — green
...
- Pending Phase 1 work packages: none — Phase 1 complete; a UAT guide lives in `docs/uat/uat-guide.md`
